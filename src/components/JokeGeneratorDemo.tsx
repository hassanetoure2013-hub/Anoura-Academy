...
import { fetchRandomJoke } from '../lib/jokeService.mock';
import type { Joke } from '../lib/jokeService';
import '../styles/jokeGenerator.css';

/**
 * Demo version of JokeGenerator using mock data
 * This is for testing purposes when the API is not accessible
 */
  ...
  return (
    <div className="joke-generator">
      <div className="joke-generator-header">
        <h2>Random Joke Generator (Demo)</h2>
